...
export const en = {
  ...
  notoColorEmoji:
    "Emojis use the Noto Colour Emoji font, licensed under the Open Font License.",
  chooseEmoji: "Choose an emoji",
  themeSettings: "Customize theme",
  themeInvalidJSON: "Invalid JSON",
  themeAccent: "Accent colour",
  themeBackground: "Background colour",
  themeForeground: "Foreground colour",
  themeAccentForeground: "Foreground accent colour",
  themeLink: "Link colour",
  ...
  closePost: "Close",
  usersMePfpColor: "Background colour of custom profile picture:",
